...
{
    [Serializable]
    public class HomingResult : Message
    {
        ...
        public HomingResult(bool success, string error)
        {
            this.success = success;
            this.error = error;
        }

        public static HomingResult Deserialize(MessageDeserializer deserializer) => new HomingResult(deserializer);

        private HomingResult(MessageDeserializer deserializer)
        {
